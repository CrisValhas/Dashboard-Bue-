...
export default function ConfirmEmail () {
    ...
    if (step === 1) return (
        <div class="mt-24 w:full flex justify-center">
            <div class="flex flex-col lg:w-95 p-9 pt-9 m-3 justify-center rounded-xl shadow-xl bg-white ">
                <h1 class="text-5xl font-semibold text-blue-400">Enviar código</h1>
                ...
                <div class="flex flex-row justify-center mt-7 gap-4">
                    <button 
                        class="w-40 h-14 mb-2 text-lg text-shadow rounded-md text-white drop-shadow-md bg-blue-400" 
                        type="submit" 
                        onClick={(e) => checkEmail(e)}> CONFIRMAR
                    </button>
                    <Link to="/auth/login">
                        <button class="w-40 h-14 mb-2 text-lg text-shadow rounded-md text-white drop-shadow-md bg-blue-400" >
                            CANCELAR
                        </button>
                    </Link>
                </div>
    ...
    if (step === 2) return (
        <div class="flex flex-col lg:w-95 p-9 pt-9 m-3 justify-center rounded-xl shadow-xl bg-white ">
            <div class="flex flex-col lg:w-95 p-9 pt-9 m-3 justify-center rounded-xl shadow-xl bg-white ">
                <h1 class="text-4xl font-semibold text-blue-400">Revisa tu email</h1>
    ...
    if (step === 3) {
        if (action === "register") return (
            <div class="mt-24 w:full flex justify-center">
                <div class="flex flex-col lg:w-95 p-9 pt-9 m-3 justify-center rounded-xl shadow-xl bg-white ">
                    <h1 class="text-4xl font-semibold text-blue-400">{credentials.email}</h1>
    ...
    if (step === 4) return (
        <div class="mt-24 w:full flex justify-center">
            <div class="flex flex-col lg:w-95 p-9 pt-9 m-3 justify-center rounded-xl shadow-xl bg-white ">
                ...
                <button class="w-40 h-14 mb-2 text-lg text-shadow rounded-md text-white drop-shadow-md bg-blue-400" type="submit" onClick={toAuth}>
                    REGRESAR
                </button>
            </div>
        </div>  
